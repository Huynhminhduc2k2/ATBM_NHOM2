...
public class RoleView extends JFrame implements WindowListener {
    ...
    public void init() {
        ...
        table_role = new JTable(model1);
        js_role = new JScrollPane(table_role, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
        ...
        js_search = new JScrollPane(table_search, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
                ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
